  ...
  <footer className="bg-surface-dark text-text-inverse">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        {/* Quick links */}
        <div>
          <h4 className="font-semibold text-text-inverse mb-4">{UI.footer.navHeading}</h4>
        ...
        {/* Contacts */}
        <div>
          <h4 className="font-semibold text-text-inverse mb-4">{UI.footer.contactHeading}</h4>
