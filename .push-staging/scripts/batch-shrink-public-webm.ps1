...
#
# Политика проекта (фаза 1 оптимизации туров): не использовать этот скрипт как основной
# способ уменьшения веса уже выкатанных клипов — повторный lossy VP9 ухудшает картинку.
# Для туров: перекодировать из исходника по одному файлу; см. docs/optimization-phase-1-public-tours.md.
#
