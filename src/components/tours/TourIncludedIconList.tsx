  ...
  return (
    ...
    >
      <div className="tour-included-icon-strip">
        <ul
          role="list"
          className="flex min-w-0 list-none flex-row flex-wrap justify-center gap-x-tour-included-icon-row-horizontal-gap gap-y-tour-included-icon-row-horizontal-gap p-0"
        >
          {items.map((item, idx) => (
