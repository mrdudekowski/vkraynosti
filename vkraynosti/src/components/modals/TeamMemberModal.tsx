...
const TeamMemberModal = ({ member }: TeamMemberModalProps) => {
  ...
  return createPortal(
    <>
      ...
      >
        <div className="bg-white rounded-modal max-w-lg w-full animate-scale-in overflow-hidden max-h-[90vh] flex flex-col">
          {/* Header image */}
          ...
          <div className="p-8 overflow-y-auto">
            ...
            <div className="mb-4">
              <h4 className="font-semibold text-text-primary text-sm mb-2">Специализации</h4>
