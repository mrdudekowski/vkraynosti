...
export const TOUR_CALENDAR_DAY_BUTTON_CLASS =
  'tour-calendar__day-btn mx-auto inline-flex aspect-square h-11 w-full max-w-tour-calendar-day-cell cursor-pointer flex-col items-center justify-center rounded-lg font-body text-sm text-text-primary transition-colors duration-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-primary disabled:cursor-not-allowed disabled:opacity-30 disabled:pointer-events-none' as const;
