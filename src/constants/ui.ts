export const UI = {
  ...
  bootSplash: {
    ...
    /**
     * Статусы под логотипом на boot splash (тон секции #safety).
     * Прототип: `dev/boot-splash-preview.html`.
     */
    statusLines: [
  ...
  telegramMiniApp: {
    ...
    tourCardDetails: 'Подробнее',
    nearestDatePrefix: 'Ближайшая дата:',
    tourPageTitle: 'Тур',
    descriptionHeading: 'Описание',
    nearestDatesHeading: 'Ближайшие даты',
    leaveRequest: 'Оставить заявку',
    openOnSite: 'Открыть на сайте',
    requestPageTitle: 'Заявка на тур',
    requestSectionHeading: 'Данные для заявки',
    selectedTourLabel: 'Выбранный тур',
    commentPlaceholder: 'Расскажите о ваших пожеланиях…',
    submitHint: 'Мы свяжемся с вами для подтверждения',
    successTitle: 'Заявка отправлена',
    successMessage:
      'Спасибо! Мы получили вашу заявку на тур и скоро свяжемся с вами.',
    successTourLabel: 'Тур:',
    successDateLabel: 'Дата:',
    successPartyLabel: 'Участников:',
    browseMoreTours: 'Смотреть другие туры',
    openWebsite: 'Открыть сайт',
    managerWillContact: 'Менеджер напишет вам в ближайшее время',
    back: 'Назад',
    decreaseParty: 'Уменьшить количество участников',
    increaseParty: 'Увеличить количество участников',
    carouselPrevious: 'Предыдущее фото',
    carouselNext: 'Следующее фото',
    openGalleryPhoto: 'Открыть фото',
    galleryViewerAria: 'Галерея тура',
    notFoundTour: 'Тур не найден',
    backToCatalog: 'Вернуться к каталогу',
    seasonTabsAria: 'Выбор сезона',
  },
} as const;
