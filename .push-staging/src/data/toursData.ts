...
const TOURS_CORE: Tour[] = [
  ...
  },
  {
    ...
    description:
      ' — приглашаем провести уикенд в нашей тёплой компании! Поездка как для опытных райдеров, так и для новичков. Будем кататься, общаться и расслабляться!',
    program: [
      {
  ...
  },
  {
    ...
    price: 'от 7 200 ₽',
    description:
      'Комбинированная поездка в Лазовский район: утром посещаем мараловую ферму с кормлением оленей, после обеда идем в Парк Драконов. Формат подойдёт для спокойного темпа, фото и знакомства с двумя яркими локациями за один день.',
    program: [
      {
        timeLabel: '04:00',
  ...
  },
  {
    ...
    includedInPrice: [
      ...
      inc('Забота команды на протяжении поездки', faHeart),
    ],
  ...
  },
  {
    ...
    description:
      ' — джип-поездка по югу Приморья, где за один день собраны бухты Витязь, Теляковского и Астафьева, реликтовые сосны, скалистые мысы и видовые точки над морем. Маршрут для тех, кто хочет увидеть дикое Приморье без суеты: прозрачную воду, вековой маяк, легенды старого края и пикник на берегу.',
    program: [
  ...
  },
  {
    ...
    description:
      ' — одна из самых доступных и красивых вершин южного Приморья. Поездка рассчитана на один активный день: бодрое восхождение, отдых на вершине, панорамы дальних хребтов и горячий ужин после спуска. Подходит тем, кто хочет яркий горный опыт без многодневного похода.',
    program: [
      { timeLabel: '07:00', description: 'Выезд из Владивостока' },
      {
        timeLabel: '09:30',
  ...
  },
  {
    ...
    description:
      ' — доступная вершина из проекта "Приморский Барс" рядом с Анисимовкой. Главная идея поездки: сочетать активный маршрут в горах и гастрономический финальный аккорд! После восхождения едем в Майхинское хозяйство на экскурсию и дегустацию.',
    program: [
      { timeLabel: '07:00', description: 'Выезд из Владивостока' },
  ...
  },
  {
    ...
    includedInPrice: [
      ...
      inc('Наше тепло и забота — это входит в каждую поездку', faHeart),
    ],
  ...
  },
  {
    ...
    program: [
      ...
      {
        timeLabel: '13:30–14:30',
        description: 'Пикник с красивым видом',
      },
      {
    ...
    includedInPrice: [
      ...
      inc('Время на отдых, фото и пикник', faBinoculars),
  ...
  },
  {
    ...
    price: 'по запросу',
    description:
      'Для тех, кто любит, когда в одном дне сочетаются природа, отдых и вкусные впечатления: утром — водопад Неожиданный, лес, пикник и купание по желанию; вечером — Майхинское хозяйство, тишина и приморское виноделие.\n\nНеожиданный — один из известных шкотовских водопадов, его ещё называют Горбатым: ключ срывается широким каскадом с высоты около десяти метров. Майхинское хозяйство в Анисимовке принимает гостей с экскурсиями и агротуризмом.',
    program: [
  ...
  },
  {
    ...
    heroPhrase:
      'Сначала — г. Сестра и бухта Ежовая. Ночь у моря и сапы ',
    duration: '2 дня / 1 ночь',
    difficulty: 'Easy',
    difficultyDisplayLabel: formatDifficultyRangeLabel('Easy', 'Medium'),
    price: 'по запросу',
    description:
      'Это два дня среди тех красот Приморья, в которые мы сами искренне влюблены. Сначала — лёгкое восхождение на Сестру, затем — бухта Ежовая с прозрачной водой и белым песком. Следующий день расслабляемся в бухтах Спокойная или Окунёвая.',
    descriptionAside:
      'А чтобы отдых у воды был ещё приятнее, мы берём с собой сапы — можно будет спокойно покататься, посмотреть на берег с воды и просто поймать то самое летнее настроение, ради которого и хочется ехать к морю.',
    program: [
      { timeLabel: 'День 1 · 06:00', description: 'Выезд из Владивостока' },
      {
    ...
    includedInPrice: [
      ...
      inc('Предоставляем сапы', faWater),
  ...
  },
  {
    id: 'summer-11',
    season: 'summer',
    title: 'Релакс-поездка в бухту Ежовую / Спокойную',
    subtitle: 'Один день у моря: отдых, сапы и красота Приморья без спешки',
    heroPhrase: 'Релакс в Ежовой, сапы и бирюзовое море',
    duration: '1 день',
    difficulty: 'Easy',
    price: 'по запросу',
    description:
...
function withPersistedDescriptionColumns(tour: Tour): Tour {
  const columns = persistTourDescriptionColumns(tour.description, tour.descriptionAside);
  if (
    columns.description === tour.description &&
    columns.descriptionAside === tour.descriptionAside
  ) {
    return tour;
  }
  return {
    ...
    ...(columns.descriptionAside != null ? { descriptionAside: columns.descriptionAside } : {}),
  };
}

export const TOURS: Tour[] = applyTourSlugs([...TOURS_BEFORE_FALL, ...FALL_TOURS]).map(
  withPersistedDescriptionColumns,
);
