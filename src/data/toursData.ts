...
export const TOURS: Tour[] = [
  ...
  },
  {
    ...
    duration: '2 дня',
    difficulty: 'Medium',
    metaAudienceLabel: `${UI.difficulty.labels.Easy}${UI.tourCard.metaAudienceDifficultyRangeSeparator}${UI.difficulty.labels.Hard}`,
  ...
  },
  {
    ...
    heroPhrase: 'Покормить маралов и пройтись среди скал-драконов',
    duration: '14–16 часов',
    difficulty: 'Easy',
    price: 'от 7 200 ₽',
    description:
  ...
  },
  {
    ...
    heroPhrase: 'Панорамная вершина и насыщенный день в горах',
  ...
  },
  {
    ...
    description:
      ' — доступная вершина из проекта "Приморский Барс" рядом с Анисимовкой. Главная идея тура: сочетать активный маршрут в горах и гастрономический финал на винодельне. После восхождения едем в Майхинское хозяйство на экскурсию и дегустацию.',
    program: [
      { timeLabel: '07:00', description: 'Выезд из Владивостока' },
