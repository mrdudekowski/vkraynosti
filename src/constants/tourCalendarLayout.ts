...
export const TOUR_CALENDAR_DAY_BUTTON_CLASS =
  'tour-calendar__day-btn inline-flex size-11 shrink-0 flex-col items-center justify-center rounded-full font-body text-sm text-text-primary transition-colors duration-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-primary disabled:opacity-30 disabled:pointer-events-none' as const;
