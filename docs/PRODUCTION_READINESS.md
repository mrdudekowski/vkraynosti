...
- [ ] **Аналитика и cookies (обязательно к продакшену):** Яндекс.Метрика (базовый вариант; альтернативы обсуждаемы), цели конверсии, **баннер согласия на cookies** и загрузка счётчика в соответствии с политикой и текстом privacy.
