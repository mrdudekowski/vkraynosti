...
export const TOURS: Tour[] = [
  // WINTER — 1 tour
  {
    ...
    price: '6 000 ₽',
    description:
      'Гора Изюбриная (1433 м) — живописная вершина в Чугуевском районе Приморского края на пересечении хребтов Белки и Лугового, популярная среди туристов. Известна как «самая снежная» вершина, популярная для зимних восхождений (сказочные заснеженные ели) и входящая в список «Лунного медведя».',
    program: [
